{ stdenv, lib, fetchzip, makeDesktopItem, unzip, dpkg, bash, temurin-jre-bin-17 }:
...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [ unzip dpkg temurin-jre-bin-17 ];
  ...
  installPhase = ''
    ...
    #!${bash}/bin/sh
    ${temurin-jre-bin-17}/bin/java -jar $out/share/AutoFirma/AutoFirma.jar \$*
    EOF
